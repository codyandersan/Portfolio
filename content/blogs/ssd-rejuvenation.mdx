...
> DISCLAIMER: This is how _I_ did it. It worked for me. It might not work for you. I am not responsible for any damage to your system or data. Proceed only if you know what you are doing.

---

## Final Result

The drive flawlessly boots as a storage device on my phone and runs Linux when I boot it from my laptop.

---

## Choosing the best distro

Out of the 600+ distros the community offers, the best for my use case was [MX Linux](https://mxlinux.org). I picked it for three reasons:
...
- 256gb SATA SSD in an external USB enclosure ([PiBOX India](https://www.pibox.in), not affiliated)
...
- Download latest [MX Linux AHS x64](https://mxlinux.org/wiki/system/advanced-hardware-support) ISO and burn it on a thumb drive using Rufus or Ventoy (I prefer the latter)
...
### From a Legacy BIOS Laptop (my case, I have a [2010 Toshiba Satellite](https://www.cnet.com/products/toshiba-satellite-l650/))
...
- Boot time (Toshiba, USB 2.0): ~55 sec
- Boot time (modern laptop): ~18 sec
