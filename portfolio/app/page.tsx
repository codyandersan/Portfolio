    ...
    <main>
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="mt-7 mx-auto grid w-full max-w-[280px] grid-cols-2 gap-2.5 sm:max-w-[320px] sm:gap-3">
            <a
              href="https://github.com/codyandersan"
              target="_blank"
              rel="noopener noreferrer"
              className="group flex items-center justify-center gap-2.5 rounded-full border border-white/15 bg-white/[0.07] px-4 py-2 text-sm font-medium text-blue-300 shadow-lg shadow-black/20 backdrop-blur-xl transition-all hover:border-blue-400/35 hover:bg-blue-500/15 hover:text-blue-200 sm:text-base"
            >
              <svg
